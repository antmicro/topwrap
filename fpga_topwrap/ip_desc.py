...
class IPCoreDescription():
    def __init__(self, name, parameters, ports, interfaces):
        if not isinstance(parameters, dict):
            raise TypeError("'parameters' argument of IPCoreDescription "
                            "shall be a dict with keys representing names "
                            "of parameters")
        if not isinstance(ports, dict):
            raise TypeError("'ports' argument of IPCoreDescription shall be "
    ...
    def save(self, filename=None):
        ...
        text = template.render(parameters=self.parameters,
                               ports=self.ports,
