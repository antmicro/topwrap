...
This document is about implementing new {class}`~topwrap.model.interconnect.Interconnect`, check [Interconnect generation](../interconnect_gen.md) to read about `Interconnect` concept in Topwrap.
...
Each interconnect needs to have implemented {class}`~topwrap.backend.generator.Generator`, refer to [Generator](generator.md) to check how to implement one.
