...
class VHDLModule:
    ...
    def get_ports(self):
        ...
        for port_name in ports.keys():
            if (
                ports[port_name]["bounds"] == "std_logic"
                or ports[port_name]["bounds"] == "std_ulogic"
            ):
...
def ipcore_desc_from_vhdl_module(
    vhdl_mod: VHDLModule, iface_grouper: InterfaceGrouper
) -> IPCoreDescription:
    ...
    iface_mappings = iface_grouper.get_interface_mappings(vhdl_mod.filename, ports)
