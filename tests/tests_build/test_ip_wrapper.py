...
def axi_dispctrl_port_names_widths() -> list:
    return [('S_AXIS_ACLK', 1), ('LOCKED_I', 1), ('s00_axi_aclk', 1), ('s00_axi_aresetn', 1),
            ('FSYNC_O', 1), ('HSYNC_O', 1), ('VSYNC_O', 1), ('DE_O', 1), ('DATA_O', 32),
            ('CTL_O', 4), ('VGUARD_O', 1), ('DGUARD_O', 1), ('DIEN_O', 1), ('DIH_O', 1),
            ('AXI_s0_AWADDR', 7), ('AXI_s0_AWPROT', 3), ('AXI_s0_AWVALID', 1), ('AXI_s0_WDATA', 32),
            ('AXI_s0_WSTRB', 4), ('AXI_s0_WVALID', 1), ('AXI_s0_BREADY', 1), ('AXI_s0_ARADDR', 7),
            ('AXI_s0_ARPROT', 3), ('AXI_s0_ARVALID', 1), ('AXI_s0_RREADY', 1), ('AXI_s0_AWREADY', 1),
            ('AXI_s0_WREADY', 1), ('AXI_s0_BRESP', 2), ('AXI_s0_BVALID', 1), ('AXI_s0_ARREADY', 1),
            ('AXI_s0_RDATA', 32), ('AXI_s0_RRESP', 2), ('AXI_s0_RVALID', 1), ('AXIS_s0_TVALID', 1),
            ('AXIS_s0_TDATA', 32), ('AXIS_s0_TLAST', 1), ('AXIS_s0_TUSER', 1), ('AXIS_s0_TREADY', 1)
        ]

@pytest.fixture
def axi_dispctrl_overriden_port_names_widths() -> list:
    return [('S_AXIS_ACLK', 1), ('LOCKED_I', 1), ('s00_axi_aclk', 1), ('s00_axi_aresetn', 1),
            ('FSYNC_O', 1), ('HSYNC_O', 1), ('VSYNC_O', 1), ('DE_O', 1), ('DATA_O', 64),
            ('CTL_O', 4), ('VGUARD_O', 1), ('DGUARD_O', 1), ('DIEN_O', 1), ('DIH_O', 1),
            ('AXI_s0_AWADDR', 7), ('AXI_s0_AWPROT', 3), ('AXI_s0_AWVALID', 1), ('AXI_s0_WDATA', 64),
            ('AXI_s0_WSTRB', 8), ('AXI_s0_WVALID', 1), ('AXI_s0_BREADY', 1), ('AXI_s0_ARADDR', 7),
            ('AXI_s0_ARPROT', 3), ('AXI_s0_ARVALID', 1), ('AXI_s0_RREADY', 1), ('AXI_s0_AWREADY', 1),
            ('AXI_s0_WREADY', 1), ('AXI_s0_BRESP', 2), ('AXI_s0_BVALID', 1), ('AXI_s0_ARREADY', 1),
            ('AXI_s0_RDATA', 64), ('AXI_s0_RRESP', 2), ('AXI_s0_RVALID', 1), ('AXIS_s0_TVALID', 1),
            ('AXIS_s0_TDATA', 64), ('AXIS_s0_TLAST', 1), ('AXIS_s0_TUSER', 1), ('AXIS_s0_TREADY', 1)
        ]
...
class TestIPWrapper:
    ...
    def test_ports_override(self, axi_dispctrl_ipw_overriden, axi_dispctrl_overriden_port_names_widths):
