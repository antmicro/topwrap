...
class TestInterfaceDef:
    ...
    def test_predefined(self):
        ...
        assert interface.interface_definitions, ('No predefined interfaces '
                                                 'could be retrieved')
...
class TestInterfaces:
    ...
    def test_iface_match(self):
        ...
        ports_correct = (('port1', 'AXIS_0_TVALID'),
                         ('port2', 'AXIS_0_TREADY')
                         )
        # signal name does not belong to the interface
        ports_incorrect = (('port1', 'AXIS_0_TVALID'),
                           ('port2', 'AXIS_0_000000')
                           )
        # interface prefixes don't match
        ports_incorrect2 = (('port1', 'AXIS_0_TVALID'),
                            ('port2', 'AXI_0_TREADY')
                            )
        # interface instances don't match
        ports_incorrect3 = (('port1', 'AXIS_0_TVALID'),
                            ('port2', 'AXIS_1_TREADY')
                            )
