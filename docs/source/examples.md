...
:graph: ../build/kpm_jsons/data_constant.json
```
...
:graph: ../build/kpm_jsons/data_inout.json
```
...
:graph: ../build/kpm_jsons/data_user_repository.json
```
...
:graph: ../build/kpm_jsons/data_hierarchy.json
```
...
:graph: ../build/kpm_jsons/data_hdmi.json
```
...
:graph: ../build/kpm_jsons/data_soc.json
```
...
:graph: ../build/kpm_jsons/data_memory_map.json
```
...
[Link to source](https://github.com/antmicro/topwrap/tree/main/examples/axi_interconnect)

```{pipeline_manager}
:spec: ../build/kpm_jsons/spec_axi_interconnect.json
:graph: ../build/kpm_jsons/data_axi_interconnect.json
```

This example has one subordinator and one manager connected to each other using AXI4 interconnect generated by Topwrap.
It is mainly used for checking if AXI4 interconnect generated by Topwrap is working in simulation.
Similar examples that focus more on interconnect representation in Topwrap can be found in [ir_examples](developer_guide/ir-examples.md)
